...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost:81/alaincms/assets/userfiles/',
    'root'         => $_SERVER['DOCUMENT_ROOT'].'/alaincms/assets/userfiles/', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
