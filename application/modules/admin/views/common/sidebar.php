...
<aside class="app-sidebar">
	...
	<ul class="app-menu">
		...
		<li><a class="app-menu__item <?php if($menuItem == 'pages'){ echo "active"; } ?>" href="<?php echo base_url('admin/pages'); ?>"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Pages</span></a></li>
		<li><a class="app-menu__item <?php if($menuItem == 'media'){ echo "active"; } ?>" href="<?php echo base_url('admin/media'); ?>"><i class="app-menu__icon fa fa-photo"></i><span class="app-menu__label">Media</span></a></li>
		<li><a class="app-menu__item <?php if($menuItem == 'menu'){ echo "active"; } ?>" href="<?php echo base_url('admin/menuSetting'); ?>"><i class="app-menu__icon fa fa-bars"></i><span class="app-menu__label">Menu</span></a></li>
