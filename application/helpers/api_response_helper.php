...
function httpResponse($data,$errorCode=null)
{  //,$status="200"
	...
	if(empty($data))
        {
            ...
            exit();
                    ...
                    if($errorCode!=null)
                        exit(json_encode(array("code"=>$errorCode,"message"=>$errorMessage,"result"=>$data),true));
                    else 
                        exit(json_encode($data,true));
             else httpResponse(array(),600);	
}
...
{
	$errorMessage = array(
            "100" => "Your not allowed for this action",
            "200" => "Ok",
            "204" => "Invalid Form Data",
            "201" => "Record Exists",
            "202" => "No record found",
            "203" => "Form Data Missing",
            "401" => 'Unauthorized',
            "300" => "Unable to update",
            "301" => "Unsuported file",
